...
$$M_{comp}:  \quad \class{alea}{Y_{k}} = \class{rouge}{\beta_0} +\class{rouge}{\beta_1} x_{k}  + \class{alea}{E_{k}},\quad \class{alea}{E_{k}\}overset{ind}{\sim}\mathcal{N}(0, \class{fixe}{\sigma^2}),$$
avec 
...
$$M_0: \quad \class{alea}{Y_{k}} = \class{rouge}{\beta_0}  + \class{alea}{E_{k}},\quad \class{ælea}{E_{k}}\overset{ind}{\sim}\mathcal{N}(0, \class{fixe}{\sigma^2}),$$
avec 
- $k=1,\ldots,n$ le numéro d'individu, $n$ le nombre total d'individus,
- $\class{rouge}{\beta_0}$ l'ordonnée à l'origine, 
...
$$\class{alea}{T} = \begin{pmatrix} \class{alea}{B_0} \\ \class{alea}{B_1} \\ \vdots \\ \class{alea}{B_p} \end{pmatrix} = (X^\intercal X )^{-1} X^\intercal \class{aea}{Y}$$
...
$$\class{fixe}{RSS_{obs}} = || \class{fixe}{Y_{obs}}- X \, \class{fixe}{\hat{\theta}}  ||^2 =  \sum_{k=1}^{n} ( \class{fixe}{y_k} - \class{fixe}{\hat{\beta}_0} + \class{fixe}{\hat{\beta}_1} x_1 + \ldots + \class{fixe}{\hat{\beta}_p} x_p)^2$$

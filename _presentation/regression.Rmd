...
$$\mathbb{E}(\bf{Y}) = \bf{X\class{rouge}{\theta}}$$ 
Il s'agit donc de résoudre un système.

--

$$\bf{X^\intercal}\mathbb{E}(\bf{Y}) = \bf{X^\intercal}\bf{X\class{rouge}{\theta}}$$ 
--

Si $\bf{X^\intercal}\bf{X}$ est inversible  alors

$$\bf{\class{rouge}{\theta}} = (X^\intercal X )^{-1} X^\intercal \mathbb{E}(Y) .$$
...
$$RSS = || Y- X \, \class{alea}{T} ||^2 = \sum_{k=1}^{n} (\class{alea}{Y_k} - \class{alea}{B_0} + \class{alea}{B_1} x_1 + \ldots + \class{alea}{B_p} x_p)^2$$

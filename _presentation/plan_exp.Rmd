...
$$X = \overset{\color{gray}{\begin{matrix}I\hspace{.4cm}&   A\hspace{.4cm}& B\hspace{.4cm} & C\hspace{.4cm}& AB \hspace{.4cm} & AC \hspace{.4cm} & BC \hspace{.4cm}   \end{matrix}}}{\begin{pmatrix}

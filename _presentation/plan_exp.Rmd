...
$$X = \overset{\color{gray}{\begin{matrix}I\hspace{.3cm}&   A\hspace{.3cm}& B\hspace{.3cm} & C\hspace{.3cm}& AB \hspace{.3cm} & AC \hspace{.3cm} & BC \hspace{.3cm}   \end{matrix}}}{\begin{pmatrix}

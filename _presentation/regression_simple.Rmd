...
Pour répondre à la question "Y a-t-il un effet de la population sur la pollution" on peut comparer les modèles
...
La question d'intérêt porte ici sur l'unique paramètre $\beta_1$. On peut donc répondre à la question sur le lien entre pollution et population en testant sir le paramètre $\beta_1$ vaut ou non 0.

...
- $\class{rouge}{\mu_1}$ la fréquence cardiaque moyenne des nageurs/nageuses  et $\class{rouge}{\mu_2}$ des partiquant.e.s de pilates et $\class{rouge}{\mu_3}$ celle des joueurs/joueuses de pétanque. 
- $\class{rouge}{\sigma^2}$ la variance commune à tous les groupes.

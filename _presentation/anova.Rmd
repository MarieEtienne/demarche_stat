...
$$\class{fixe}{\hat{\mu}} = \class{fixe}{y_{1\bullet}}=\frac{1}{20}\sum_{k=1}^{20} y_{1k}, \quad \class{fixe}{\hat{\alpha}_2} =\class{fixe}{y_{2\bullet}}-\class{fixe}{y_{1\bullet}}=\frac{1}{20}\sum_{k=1}^{20} \class{fixe}{y_{2k}} - \frac{1}{20}\sum_{k=1}^{20} \class{fixe}{y_{1k}}$$
...
$\class{fixe}{\hat{\mu}} =$ `r resM1$m[1]` et $\class{fixe}{\hat{\alpha}_2}=$ `r resM1$m[2] - resM1$m[1]`. 

...
.pull-left[
###  Estimateur des paramètres de moyenne$
...
$$RSS(\mu,\alpha_i,\beta_j,\gamma_{ij}) =  \sum_{i=1}^{I} \sum_{j=1}^{J} \sum_{k=1}^{n_{ij}} \left \lbrace {y_{ijk}} - (  {\mu} + {\alpha_i} + {B=\beta_j} + {\gamma_{ij}}) \right\rbrace ^2$$
]
